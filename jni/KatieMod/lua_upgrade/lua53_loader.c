...
void (*lua_rotate_new)(lua_State *L, int idx, int n);
void (*lua_copy_new)(lua_State *L, int fromidx, int toidx);
int (*lua_checkstack_new)(lua_State *L, int n);
...
int (*lua_isinteger_new)(lua_State *L, int idx);
...
const char *(*lua_pushlstring_new)(lua_State *L, const char *s, size_t len);
...
int (*lua_getglobal_new)(lua_State *L, const char *name);
int (*lua_gettable_new)(lua_State *L, int idx);
int (*lua_getfield_new)(lua_State *L, int idx, const char *k);
int (*lua_geti_new)(lua_State *L, int idx, lua_Integer n);
int (*lua_rawget_new)(lua_State *L, int idx);
int (*lua_rawgeti_new)(lua_State *L, int idx, lua_Integer n);
int (*lua_rawgetp_new)(lua_State *L, int idx, const void *p);
...
int (*lua_getuservalue_new)(lua_State *L, int idx);
void (*lua_setglobal_new)(lua_State *L, const char *name);
void (*lua_settable_new)(lua_State *L, int idx);
void (*lua_setfield_new)(lua_State *L, int idx, const char *k);
void (*lua_seti_new)(lua_State *L, int idx, lua_Integer n);
void (*lua_rawset_new)(lua_State *L, int idx);
void (*lua_rawseti_new)(lua_State *L, int idx, lua_Integer n);
...
void (*lua_callk_new)(lua_State *L, int nargs, int nresults, lua_KContext ctx, lua_KFunction k);
int (*lua_pcallk_new)(lua_State *L, int nargs, int nresults, int errfunc, lua_KContext ctx, lua_KFunction k);
int (*lua_load_new)(lua_State *L, lua_Reader reader, void *dt, const char *chunkname, const char *mode);
int (*lua_dump_new)(lua_State *L, lua_Writer writer, void *data, int strip);
int (*lua_yieldk_new)(lua_State *L, int nresults, lua_KContext ctx, lua_KFunction k);
int (*lua_resume_new)(lua_State *L, lua_State *from, int narg);
int (*lua_status_new)(lua_State *L);
int (*lua_isyieldable_new)(lua_State *L);
...
size_t (*lua_stringtonumber_new)(lua_State *L, const char *s);
...
void (*lua_sethook_new)(lua_State *L, lua_Hook func, int mask, int count);
...
int (*luaopen_utf8_new)(lua_State *L);
...
int (*lua_gethookmask_new)(lua_State *L);
int (*lua_gethookcount_new)(lua_State *L);
void (*luaL_checkversion__new)(lua_State *L, lua_Number ver, size_t sz);
...
int (*luaL_argerror_new)(lua_State *L, int arg, const char *extramsg);
const char *(*luaL_checklstring_new)(lua_State *L, int arg, size_t *l);
const char *(*luaL_optlstring_new)(lua_State *L, int arg, const char *def, size_t *l);
lua_Number (*luaL_checknumber_new)(lua_State *L, int arg);
lua_Number (*luaL_optnumber_new)(lua_State *L, int arg, lua_Number def);
lua_Integer (*luaL_checkinteger_new)(lua_State *L, int arg);
lua_Integer (*luaL_optinteger_new)(lua_State *L, int arg, lua_Integer def);
void (*luaL_checkstack_new)(lua_State *L, int sz, const char *msg);
void (*luaL_checktype_new)(lua_State *L, int arg, int t);
void (*luaL_checkany_new)(lua_State *L, int arg);
...
int (*luaL_checkoption_new)(lua_State *L, int arg, const char *def, const char * const lst[]);
...
lua_Integer (*luaL_len_new)(lua_State *L, int idx);
...
void lua_upgrade_load52(void) {
	...
	if (!(lua_geti_new = dlsym(liblua, "lua_geti"))) {
		LogW("lua_upgrade: Failed to load function %s", "lua_geti");
	}
	...
	if (!(lua_isinteger_new = dlsym(liblua, "lua_isinteger"))) {
		LogW("lua_upgrade: Failed to load function %s", "lua_isinteger");
	}
	...
	if (!(lua_isyieldable_new = dlsym(liblua, "lua_isyieldable"))) {
		LogW("lua_upgrade: Failed to load function %s", "lua_isyieldable");
	}
	...
	if (!(lua_rotate_new = dlsym(liblua, "lua_rotate"))) {
		LogW("lua_upgrade: Failed to load function %s", "lua_rotate");
	}
	...
	if (!(lua_seti_new = dlsym(liblua, "lua_seti"))) {
		LogW("lua_upgrade: Failed to load function %s", "lua_seti");
	}
	...
	if (!(lua_stringtonumber_new = dlsym(liblua, "lua_stringtonumber"))) {
		LogW("lua_upgrade: Failed to load function %s", "lua_stringtonumber");
	}
	...
	if (!(luaopen_utf8_new = dlsym(liblua, "luaopen_utf8"))) {
		LogW("lua_upgrade: Failed to load function %s", "luaopen_utf8");
	}
}
